...
Forums.i18n = {
    ...Forums.i18n,
    ...{
        // have a 'en' key so that it is used even if the application asks for 'en_US, 'en_GB' and so on
        en: {
            allPosts: {
            ...
            forum_edit: {
                ...
                moderators_text: 'In addition to the \'FRS_MODERATOR\' role, select here users which will be authorized to moderate <b>this</b> forum.',
                title_label: 'Title',
            ...
            moderate: {
                ...
                unvalidated: 'The post has been successfully unvalidated, is now waiting for a new validation',
